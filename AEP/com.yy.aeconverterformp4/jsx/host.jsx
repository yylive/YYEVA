...
var DynamicMp4Conveter = (function () {
  ...
  DynamicMp4Conveter.prototype.beginConveter = function (tempPath, alphaAuto) {
    ...
    var activeItem = app.project.activeItem
    var originItem = app.project.activeItem
    ...
    for (var i = 1; i <= layerLength; i++) {
      var layer = layerCollection[layerLength - i + 1]; //逆序读取 保证客户端的次序
      logMessage("当前是:" + layer.name);
      if (layer.name.match(MaskCompo_Text)) {
    ...
    } else if (alphaAuto == "true") {
      aspectAlphaRatio = 1.0
    }


    logMessage("scaleAlpha aspect:" + aspectAlphaRatio + ",alphaAuto:" + alphaAuto)
